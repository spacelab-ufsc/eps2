...
The EPS module can be programed and debugged through its JTAG PicoBlade connector as showed in \autoref{fig:jtag-picoblade}. 
...
This feature enables powering the board partially using MSP-FET, be advised to leave this connector open if the EPS is on from other means, for more details see \autoref{ch:instructions}.
