...
#define PANNEL_MINUS_Y_CURRENT_SENSOR_ADC_PORT ADC_PORT_0
#define PANNEL_PLUS_X_CURRENT_SENSOR_ADC_PORT ADC_PORT_1
#define PANNEL_MINUS_X_CURRENT_SENSOR_ADC_PORT ADC_PORT_2
#define PANNEL_PLUS_Z_CURRENT_SENSOR_ADC_PORT ADC_PORT_3
#define PANNEL_MINUS_Z_CURRENT_SENSOR_ADC_PORT ADC_PORT_4
#define PANNEL_PLUS_Y_CURRENT_SENSOR_ADC_PORT ADC_PORT_5
#define EPS_BEACON_CURRENT_SENSOR_ADC_PORT ADC_PORT_6
